// closed_complaint_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:pof_e_services/services/auth_service.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class ClosedComplaintsScreen extends StatelessWidget {
  const ClosedComplaintsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final authService = Provider.of<AuthService>(context);

    // This stream should now return only closed complaints, filtered on the server.
    final Stream<QuerySnapshot> allComplaintsStream =
        authService.getClosedComplaints();
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          final closedComplaints = snapshot.data!.docs;

          if (closedComplaints.isEmpty) {
            return const Center(child: Text('No closed complaints found.'));
          }
          ...
          return SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children:
                    closedComplaints.map((DocumentSnapshot document) {
